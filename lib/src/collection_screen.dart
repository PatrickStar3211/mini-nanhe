...
const _decorationEntries = <_CollectionCardData>[
  ...
  _CollectionCardData(
    id: 'home-bedroom',
    title: '卧室',
    description: '小南河在家里的温暖卧室。',
    unlocked: false,
    icon: Icons.bedroom_child_rounded,
    accent: gold,
    imageAsset: homeBedroomDayAsset,
  ),
  _CollectionCardData(
    id: 'home-living-room',
    title: '客厅',
    description: '有大沙发和电视的客厅。',
    unlocked: false,
    icon: Icons.weekend_rounded,
    accent: deepBlue,
    imageAsset: homeLivingRoomDayAsset,
  ),
  _CollectionCardData(
    id: 'home-study',
    title: '书房',
    description: '可以学习，也可以打英雄联盟。',
    unlocked: false,
    icon: Icons.computer_rounded,
    accent: azure,
    imageAsset: homeStudyDayAsset,
  ),
];
